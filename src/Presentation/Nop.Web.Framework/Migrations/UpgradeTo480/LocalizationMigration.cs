...
public class LocalizationMigration : MigrationBase
{
    ...
    public override void Up()
    {
        ...
        localizationService.AddOrUpdateLocaleResource(new Dictionary<string, string>
        {
            ...
            //#2388
            ["Admin.Configuration.Settings.Catalog.ExportImport"] = "Export/Import products with tier prices",
            ["Admin.Configuration.Settings.Catalog.ExportImport.Hint"] = "Check if products should be exported/imported with tier prices.",
        }, languageId);
